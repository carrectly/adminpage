...
const UpdateDriver = ({ driver }) => {
  ...
  const onFinish = (values) => {
    dispatch(updateDriverThunk(driver.id, values));
    handleClose();
  };
  ...
  return (
    <div>
      ...
      ></Button>
      <Modal title={`${driver.name}`} visible={show} footer={null} closable={false}>
        <Form
          {...layout}
          form={form}
          name="control-hooks"
        ...
        >
          ...
          <Form.Item label="Phone number">
            <Form.Item name="phoneNumber" noStyle initialValue={driver.phoneNumber}>
              <Input />
            </Form.Item>
          </Form.Item>
          <Form.Item label="Image URL">
            <Form.Item name="imageUrl" noStyle initialValue={driver.imageUrl || ''}>
              <Input />
            </Form.Item>
          </Form.Item>
